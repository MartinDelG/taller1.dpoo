...
public class ConsolaOlimpicos
{
	...
	private void ejecutarPaisDadoAtleta()
	{
		System.out.println("\n" + "Pais al que pertenece un atleta");
		String atleta = input("Por favor ingrese el nombre de un atleta");
		String nombre = calculadora.paisDadoAtleta(atleta);
		System.out.println("El pais al que pertenece el atleta es: " + nombre);
	}
	/**
